...
int main(int argc, char** argv)
{
	...
	static APPLICATION_LABELS labels =
	{
		...
		{"File", "New", "Open", "Open As Layer", "Save", "Save as", "Close", "Quit", "Edit", "Undo", "Redo",
			...
			"_New Layer(Vector)", "_New Layer Set", "_Copy Layer", "_Delete Layer", "Fill with _FG Color",
			"Fill with Pattern", "Rasterize Layer", "Merge Down", "_Flatten Image", "_Visible to Layer",
			"Visible Copy", "Select", "None", "Invert", "All", "Grow", "Shrink", "View", "Zoom", "Zoom _In",
			"Zoom _Out", "Actual Size", "Reverse Horizontally", "Rotate", "Reset Roatate", "Display Filters",
			"Nothing", "Gray Scale", "Gray Scale (YIQ)", "Filters", "Blur", "Motion Blur", "Brightness & Contrast",
			"Hue & Saturation", "Luminosity to Opacity", "Colorize with Under Layer", "Gradation Map",
			"Map with Detect Max Black Value", "Transparency as White", "Fill with Vector", "Script", "Help", "Version"
		},
		...
		{"Tool Box", "Initialize", "New Brush", "Smooth", "Quality", "Rate", "Gaussian", "Average", "Magnification",
			...
			"Single Pixel", "Average Color", "Open Path", "Close Path",
		...
		{"Layer", "Layer", "Vector", "Layer Set", "Text", "Add Layer", "Add Vector Layer", "Add Layer Set",
			"Rename Layer", "Reorder Layer", "Opacity to Selection Area", "Opacity Add Selection Area",
			"Pasted Layer", "Under Layer", "Mixed Under Layer", "Blend Mode", "Opacity", "Masking with Under Layer",
			"Lock Opacity",
