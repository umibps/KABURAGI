...
static cairo_rectangle_int_t check_RectangleInt(lua_State* L, int idx)
{
    ...
    rect.x      = (int)get_numfield(L, "x");
    rect.y      = (int)get_numfield(L, "y");
    rect.width  = (int)get_numfield(L, "width");
    rect.height = (int)get_numfield(L, "height");
...
static int luaopen_lrectangleint (lua_State *L)
{
	...
	luaL_newlib(L, RectangleInt_methods);
	lua_setglobal(L, "RectangleInt");
	...
	luaL_newlib(L, RectangleInt_meta_methods);
	lua_setglobal(L, "RectangleInt.mt");
